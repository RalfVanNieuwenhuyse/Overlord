...
void UberMaterial::InitializeEffectVariables()
{
	...
	m_pDiffuseTexture = ContentManager::Load<TextureData>(L"Textures/UberShader/Skulls_Diffusemap.tga");
	SetVariable_Texture(L"gTextureDiffuse", m_pDiffuseTexture);
	SetVariable_Scalar(L"gUseTextureDiffuse", true);
	SetVariable_Vector(L"gColorDiffuse", { 1, 1, 1, 1 });

	m_pSpecularTexture = ContentManager::Load<TextureData>(L"Textures/UberShader/Skulls_HeightMap.tga");
	...
	m_pNormalTexture = ContentManager::Load<TextureData>(L"Textures/UberShader/Skulls_NormalMap.tga");
	SetVariable_Texture(L"gTextureNormal", m_pNormalTexture);
	...
	m_pEnvironmentTexture = ContentManager::Load<TextureData>(L"Textures/UberShader/Sunol_Cubemap.dds");
	SetVariable_Texture(L"gCubeEnvironment", m_pEnvironmentTexture);
	...
	//Opacity
	m_pOpacityTexture = ContentManager::Load<TextureData>(L"Textures/UberShader/Skulls_HeightMap.tga");
	SetVariable_Texture(L"gTextureOpacity", m_pOpacityTexture);
