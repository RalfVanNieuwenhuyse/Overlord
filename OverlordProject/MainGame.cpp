...
#ifdef GRADWORK
#include "Scenes/GradWork/SummonTestScene.h"
...
void MainGame::OnGamePreparing(GameContext& gameContext)
{
	...
	//gameContext.windowTitle = L"GP2 - Milestone 1 (2023) | (2DAE15) Van Nieuwenhuyse Ralf";
	//gameContext.windowTitle = L"GP2 - Milestone 2 (2023) | (2DAE15) Van Nieuwenhuyse Ralf";
	gameContext.windowTitle = L"GP2 - Exam Project (2023) | (2DAE15) Van Nieuwenhuyse Ralf";
}
...
#ifdef GRADWORK	
	SceneManager::Get()->AddGameScene(new SummonTestScene());
#endif
...
LRESULT MainGame::WindowProcedureHook(HWND /*hWnd*/, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	if(message == WM_KEYUP)
	{
		...
		//[F6] If PhysX Framestepping is enables > Next Frame	
		if (wParam == VK_F6)
		{
			const auto pScene = SceneManager::Get()->GetActiveScene();
